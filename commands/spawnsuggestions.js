...
module.exports = {
	...
	async execute(interaction) {
		...
		const embed = new EmbedBuilder()
			...
			.setThumbnail("https://www.iconpacks.net/icons/2/free-feedback-icon-2949-thumb.png")
			.setDescription("Cliquez sur le bouton ci-dessous pour proposer une suggestion pour le robot discord.\nTout abus sera sanctionné.")
